...
function listaProdutos($conexao){ //funcao que busca os dados no banco
  $produtos = array();
  $resultado =  mysqli_query($conexao, "select p.*,c.nome as categoria_nome from produtos as p join categorias as c on
  c.id=p.categoria_id");
